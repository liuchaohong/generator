<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<script src="<c:url value="/js/underscore.js"/>" type="text/javascript"
	></script>
	<script src="<c:url value="/js/My97DatePicker/WdatePicker.js"/>" type="text/javascript"></script>

	<!-- multiple-select -->
	<script src="${r'${ctx}'}/js/multiple-select/jquery.multiple.select.js"></script>
	<link href="${r'${ctx}'}/js/multiple-select/multiple-select.css" rel="stylesheet"  media="screen"/>
