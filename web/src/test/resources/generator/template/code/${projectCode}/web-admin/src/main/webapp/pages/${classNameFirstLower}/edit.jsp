...
<rapid:override name="head">
	<title>${className}编辑</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">编辑${className}</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${r'${ctx}'}/${classNameFirstLower}/update.do">
