...
<#list table.columns as column>
	...
	<div class="form-group">
		...
		<#else>
			<input value="${dollar}{${classNameLower}.${column.columnNameLower}}" name="${column.columnNameLower}" id="${column.columnNameLower}" class="form-control" maxlength="${column.size}" placeholder="${column.columnNameLower}"/>
		</#if>
